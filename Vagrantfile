...
BOX_NAME = ENV['BOX_NAME'] || "timtec-php-env-ubuntu-docker"
...
Vagrant.configure("2") do |config|
    config.vm.network :forwarded_port, :host => 48080, :guest => 8080
    config.vm.network :forwarded_port, :host => 48888, :guest => 8888
end
